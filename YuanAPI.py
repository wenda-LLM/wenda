...
def load_model():
    ...
    tokenizer = T5Tokenizer.from_pretrained("ChatYuan-large-v2", local_files_only=True)
    model = T5ForConditionalGeneration.from_pretrained("ChatYuan-large-v2", local_files_only=True).half()
    import torch
