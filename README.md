...
<!-- Added by: runner, at: Thu May 11 11:01:58 UTC 2023 -->
...
| find_dynamic(s, step = 1, paraJson) | 从动态知识库查找；参考闻达笔记Auto      | paraJson如{libraryStategy:"sogowx:3",maxItmes:2}                    |
| zsk (b=true)                        | 开关知识库。                            |                                                                     |
| lsdh (b=true)                       | 开关历史对话。                          |                                                                     |
| speak (s)                           | 使用TTS引擎朗读文本。                   |                                                                     |
| copy (s)                            | 使用浏览器`clipboard-write`负责文本。   | 需要相关权限组                                                      |
### 部分内置 Auto 使用说明
| 文件名               | 功能                                                                                |
| -------------------- | ----------------------------------------------------------------------------------- |
