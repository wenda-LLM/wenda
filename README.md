...
| ------------------------- | ---------- | ---------- | ---------------------- | ------- | ---------------------- | -------- |
| [chatGLM-6B](#chatglm-6b) | 支持       | 支持       | 需安装编译器           | 支持    | 支持预先量化和在线量化 | 支持     |
| RWKV [torch](#torch)版    | 支持       | 支持       | 支持                   | 支持    | 支持预先量化和在线量化 |          |
| RWKV [cpp](#cpp)版        | 支持       | 支持       | 支持且可使用指令集加速 |         | 支持预先量化           |          |
| Baichuan-7B               | 支持       | 支持       | 支持                   | 支持    |                        | 支持     |
| [Aquila-7B](#aquila-7b)   |            | 官方未实现 | 支持                   | 支持    |                        |          |
| replit                    |            |            | 支持                   | 支持    |                        |          |
| chatglm130b api           | 支持       |            |                        |         |                        |          |
| openai api                | 支持       | 支持       |                        |         |                        |          |
| llama.cpp                 | 支持       | 支持       | 支持且可使用指令集加速 |         | 支持预先量化           |          |
| llama torch               | 支持       | 支持       | 支持                   | 支持    | 支持预先量化和在线量化 |          |
### 懒人包
#### 百度云
