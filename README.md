...
<!-- Added by: runner, at: Sat Apr 29 01:25:22 UTC 2023 -->

<!--te-->
## 简介
针对特定环境的内容生成是LLM使用中的一项重要功能。因个人没能力做全量微调，lora微调只能牺牲基础能力换单任务效果（用6B模型lora调出来的单任务效果，专门设计一个0.5B模型也能实现，且推理成本更低）。因此本项目采用知识库+auto脚本的形式为LLM提高生成能力，此方案充分考虑个人和中小企业的资源问题，以及国内大背景下知识安全和私密性问题,实现使小模型获得近似于大模型的生成能力。
