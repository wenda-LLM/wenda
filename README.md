...
| 0-zsk.js                                   | 知识库增强和管理                                                            | ---                                               |
| face-recognition.js                        | 浏览器端人脸检测，通过识别嘴巴开合，控制语音输入开关                        | 需要授予相关权限，因浏览器限制，仅本地或TLS下可用 |
| QQ.js                                      | QQ机器人 [配置参考](https://drincann.github.io/Mirai-js/#/v2.x/Preparation) | 把里面第一行`my_account`改成你的QQ号              |
| block_programming_that_cats_can_also_do.js | 猫猫也会的图块化编程                                                        | 通过拖动图块实现简单Auto功能                      |
