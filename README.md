...
<!-- Added by: runner, at: Mon May  1 00:03:46 UTC 2023 -->
...
建议在[discussions](https://github.com/l15y/wenda/discussions)中讨论
...
## Auto
auto功能为一段JavaScript脚本，通过油猴脚本或直接放到`autos`目录的方式注入至程序，为闻达附加各种自动化功能。
